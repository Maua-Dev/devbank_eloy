...
from src.app.main import get_user_info
...
class Test_Main:
    ...
    def test_get_user_info(self):
        ...
        assert response == {
            "name":repo.get_item(1).name,
            "account":repo.get_item(1).account,
            "agency":repo.get_item(1).agency,
            "current_balance": repo.get_item(1).current_balance
        }
